...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-md-9 well">
    	<h3 class="text-center">归龙斜塔空间信息</h3>
		<dl>
			<dt></dt>
			...
			<dd>
				<div class="col-sm-5">
			      <div class="row">
					  ...
					  <div class="col-sm-4">
					    <a href="#" class="thumbnail">
					      <img data-src="holder.js/180x180" alt="180x180" src="<%=request.getContextPath()%>/images/glxt2.jpg" style="width: 180px; height: 180px;">
					    </a>
					  </div>
					  <div class="col-sm-4">
					    <a href="#" class="thumbnail">
					...
					<div class="row">
					  <div class="col-sm-4">
					    <a href="#" class="thumbnail">
					      <img data-src="holder.js/180x180" alt="180x180" src="<%=request.getContextPath()%>/images/glxt4.jpg" style="width: 180px; height: 180px;">
					    </a>
					  </div>
					  <div class="col-sm-4">
					    <a href="#" class="thumbnail">
