...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-md-10 well">
    	<h3 class="text-center">归龙斜塔卫星地图展示</h3>
    	<dl class="paragraph">
			<dt>归龙斜塔卫星地图说明</dt>
			<dd></dd>
		</dl>
					  ...
					  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
						  ...
						  <div class="carousel-inner" role="listbox">
						    <div class="item active">
						      <img src="<%=request.getContextPath()%>/images/gis_glxt.jpg" alt="" style="width:800px; height:450px;">
						      <div class="carousel-caption">
						      </div>
						    </div>
						    <div class="item">
						      <img src="<%=request.getContextPath()%>/images/gis_glxt1.jpg" alt="" style="width:800px; height:450px;">
						      <div class="carousel-caption">
						      </div>
						    </div>
						    <div class="item">
						      <img src="<%=request.getContextPath()%>/images/gis_glxt2.jpg" alt="" style="width:800px; height:450px;">
						      <div class="carousel-caption">
						      </div>
						    </div>
						    <div class="item">
						      <img src="<%=request.getContextPath()%>/images/gis_glxt3.jpg" alt="" style="width:800px; height:450px;">
						      <div class="carousel-caption">
						      </div>
						    </div>
						  </div>
