...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-md-10 well">
    	<h3 class="text-center">杨美古镇空间信息</h3>
		<dl>
			<dt></dt>
		...
		<dl class="paragraph">
			...
			<dd>
				<div class="col-sm-5">
			      <div class="row">
					  <div class="col-sm-4">
					    <a href="<%=request.getContextPath()%>/images/ymgz1.jpg" class="thumbnail">
					      <img data-src="holder.js/180x180" alt="180x180" src="<%=request.getContextPath()%>/images/ymgz1.jpg" style="width: 180px; height: 180px;">
					    </a>
					  </div>
					  <div class="col-sm-4">
					    <a href="<%=request.getContextPath()%>/images/ymgz2.jpg" class="thumbnail">
					      <img data-src="holder.js/180x180" alt="180x180" src="<%=request.getContextPath()%>/images/ymgz2.jpg" style="width: 180px; height: 180px;">
					    </a>
					  </div>
					  <div class="col-sm-4">
					    <a href="<%=request.getContextPath()%>/images/ymgz3.jpg" class="thumbnail">
					...
					<div class="row">
					  <div class="col-sm-4">
					    <a href="<%=request.getContextPath()%>/images/ymgz4.jpg" class="thumbnail">
					      <img data-src="holder.js/180x180" alt="180x180" src="<%=request.getContextPath()%>/images/ymgz4.jpg" style="width: 180px; height: 180px;">
					    </a>
					  </div>
					  <div class="col-sm-4">
					    <a href="<%=request.getContextPath()%>/images/ymgz5.jpg" class="thumbnail">
					      <img data-src="holder.js/180x180" alt="180x180" src="<%=request.getContextPath()%>/images/ymgz5.jpg" style="width: 180px; height: 180px;">
					    </a>
					  </div>
					  <div class="col-sm-4">
					    <a href="<%=request.getContextPath()%>/images/ymgz6.jpg" class="thumbnail">
